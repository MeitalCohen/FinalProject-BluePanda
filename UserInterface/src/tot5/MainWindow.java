	...
	implements ChangeListener, ListSelectionListener, ItemListener, PropertyChangeListener, ActionListener
{
	...
	private void initializeComponent()
	{
		...
		panel2.setBackground(new Color(0xB9, 0xD1, 0xEA));
		// glassEffectPanel
		glassEffectPanel.setBackground(new Color(0xD7, 0xE4, 0xF2));
		...
		// panel3
		panel3.setBackground(new Color(0xB9, 0xD1, 0xEA));
		...
		// aeroEffectPanel
		aeroEffectPanel.setBackground(new Color(0xD7, 0xE4, 0xF2));
		...
		panel8.add(panel10);
		// panel6
		panel6.setBackground(new Color(0xD7, 0xE4, 0xF2));
		panel6.add(label4);
		...
		panel5.setBackground(new Color(0xB9, 0xD1, 0xEA));
		// panel9
		panel9.add(label11);
		panel9.setBackground(new Color(0xB9, 0xD1, 0xEA));
		panel9.setPreferredSize(new Dimension(0, 32));
		// panel10
		panel10.setBackground(new Color(0xD7, 0xE4, 0xF2));
