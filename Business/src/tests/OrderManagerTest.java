...
public class OrderManagerTest {
    ...
    public void insertOrder_HappyPath_newBook() {
        ...
        User newUser = new User("1", "username", "Meital", "Cohen", "password", 2, new Date(System.currentTimeMillis()), 1, "Tel Aviv", "rew@fe.fd", "43242", true);
    ...
    public void insertOrder_HappyPath_bookExist() {
        ...
        BookStock book = new BookStock("1","1", "Lin", 3, "SiFi", "SiFi", "");
        BookStock book2 = new BookStock("2","2", "Lin", 3, "SiFi", "SiFi", "");
        Order newOrder = new Order("1", 1, now, now, false, "1", "1", "Lin", 2);
